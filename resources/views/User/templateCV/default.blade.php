        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 text-center">
                    <!-- Avatar Image -->
                    <img src="{{ '/userPic/' . $information->picture . '.jpg' }}" alt="avatar" class="img-responsive img-profile thumbnail">
                ...
                <div class="col-sm-12 col-md-3">
                    ...
                    <div class="contact">
                        ...
                        <ul class="list-unstyled contact-list">
                            <li><i class="fa fa-mobile"></i><span class="pull-right">{{ $information->phone }}</span></li>
                            <li><i class="fa fa-envelope"></i><span class="pull-right">{{ $information->mail }}</span></li>
                            <li><i class="fa fa-skype"></i><span class="pull-right">{{ $information->skype}}</span></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <ul class="list-unstyled">
                            <li>Birthday<span class="pull-right">{{ $information->birthday }}</span></li>
                            <li>Address<span class="pull-right">{{ $information->address }}</span></li>
                        </ul>
                    </div>
